	 ...
	 //$urlRouterProvider.otherwise('/page/login');
      ...
      .state('page', {
        ...
        .state('page.register', {
		  ...
		  .state('page.registershipper', {
          url: '/registershipper',
          templateUrl: Route.base('page.registershipper.html')
        })
		  .state('page.registertrucker', {
          url: '/registertrucker',
          templateUrl: Route.base('page.registertrucker.html')
        })
		  .state('page.paymentsetup', {
          url: '/paymentsetup',
          templateUrl: Route.base('page.paymentsetup.html')
        })
        .state('page.recover', {
          url: '/recover',
